...
[14. Variadic Functions](https://github.com/kubotravis/my_notes/blob/master/Golang_Related/Golang_Notes.md#14-variadic-functions)

[15. Closures](https://github.com/kubotravis/my_notes/blob/master/Golang_Related/Golang_Notes.md#15-closures)

[16. Recursion](https://github.com/kubotravis/my_notes/blob/master/Golang_Related/Golang_Notes.md#16-recursion)
...
// Function takes arbitary nunmber of arguments in ints
func sum(nums...int) {
  fmt.Println(nums, " ")
  total := 0
  for _, num := range nums {
